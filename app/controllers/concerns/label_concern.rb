module LabelConcern
  ...
  # (e.g. a journey/evo-flow caller carrying an id absent from the local
  # `labels` table) must NOT be silently dropped — preserve it as a literal so
  # the intent still becomes a tagging.
